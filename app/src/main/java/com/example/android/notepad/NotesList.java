...
public class NotesList extends ListActivity {
    ...
    /*    MenuItem search=menu.findItem(app_bar_search);
        SearchView sv=(SearchView) this.findViewById(R.id.app_bar_search);
          ...
          @Override
           ...
           public boolean onQueryTextChange(String newText) {
            String selection = NotePad.Notes.COLUMN_NAME_TITLE + "=?";
                ...
                NotesList.this.setListAdapter(adapter1);
                return true;
            }
        });*/
...
//END_INCLUDE(copy)
    ...
    protected void onListItemClick(ListView l, View v, int position, long id) {
        ...
        if (Intent.ACTION_PICK.equals(action) || Intent.ACTION_GET_CONTENT.equals(action)) {
            ...
            startActivity(new Intent(Intent.ACTION_EDIT, uri));// Intent's data is the note ID URI. The effect is to call NoteEdit.
